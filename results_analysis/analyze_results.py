...
try:
    ...
    with open(csv_file_path, mode='r', newline='', encoding='utf-8') as file:
        ...
        #Skip the first arrival
        arrival_1 = next(reader, None)
        print("First arrival:", arrival_1)
    ...
    if (len(departure_times)!=50 or len(arrival_times)!=50):
