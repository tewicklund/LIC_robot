...
grid_title=file_path.split('/')[-1].removesuffix('.csv')
path=file_path.removesuffix(grid_title+'.csv')

#list to store LIC posts
LIC_post_list=csv_to_LIC_post_list(file_path)
...
export_grid_as_png(grid_title,grid_chars,path)
